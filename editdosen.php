...
if (isset($_GET['idDosen'])) {
    // ambil nilai idDosen dari url dan disimoan dalam variabek $ud
    $id = ($_GET["idDosen"]);
...
// ,engambil data dari database dan membuat variabel - variabel untuk menampung data
...
$noHP =$data["noHP"];
    ...
    // apabila tidak ada fata GET id pada akan di redirect ke index.php
    ...
    <body>
        ...
        <fieldset>
            ...
            <p>
                ...
                <input type="text" name="namaDosenDisabled" id="namaDosen" value="<?php echo $namaDosen ?>"> 
        </p>
        <p>
